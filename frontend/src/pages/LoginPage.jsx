 ...
 * Authentication with architectural/magazine aesthetic
 */
export function LoginPage() {
  ...
  return (
    <>
      <EditorialNav />
      <EditorialPage showGrid={true} showPath={false}>
        <EditorialSection spacing="xl">
          <EditorialContainer size="sm">
            <div style={{ textAlign: 'center' }}>
              ...
              <BrushHeading size="lg" style={{ marginBottom: '1rem' }}>
                Sign In
              </BrushHeading>
              ...
              {/* Auth Card */}
              <EditorialCard variant="bordered" padding="xl">
                <div style={{ 
                  display: 'flex', 
